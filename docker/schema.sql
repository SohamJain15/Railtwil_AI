...
DO $$ DECLARE table_name TEXT; BEGIN
  FOREACH table_name IN ARRAY ARRAY['tracks','blocks','platforms','junctions','routes','trains','timetables','train_movements','train_states','events','conflicts','simulation_runs','simulation_events','recommendations','what_if_results','safety_checks','metrics'] LOOP
